...
-----------------
### {.value-box}
```{r Gold Prediction Linear}
valueBox(last_row.gold, caption = "Gold Prediction Linear", icon = "glyphicon-oil")
```

### {.value-box}
```{r Gold RMSE}
valueBox(gold.perf.tree$RMSE,caption = "Gold RMSE", icon = 'glyphicon-sort')
```
...
# Plot
p <- simpleNetwork(data, height="1000px", width="1000px")
p
```
